...
public class MatchedCompanyActivity extends AppCompatActivity {
    Rest rest;
    Context mContext;
    ImageView iv_back;
    TextView tv_nodata;
    ...
    public static MatchedCompanyActivity instance;
    ...
    private void getMatchedJobs() {
        SwipeeApiClient.swipeeServiceInstance().getMatchedJobList(Config.GetUserToken()).enqueue(new Callback<JsonObject>() {
            @Override
