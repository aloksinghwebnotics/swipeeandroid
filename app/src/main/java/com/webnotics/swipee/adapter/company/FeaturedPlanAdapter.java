...
import com.webnotics.swipee.activity.company.FeaturedPlan;

import java.text.MessageFormat;


public class FeaturedPlanAdapter extends RecyclerView.Adapter<FeaturedPlanAdapter.MyViewHolder> {

    FeaturedPlan mContext;
    JsonArray data;
    private MyViewHolder oldHolder;


    public FeaturedPlanAdapter(FeaturedPlan mContext, JsonArray data) {
    ...
    @NonNull
    @Override
    public FeaturedPlanAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
