...
public class CompanyPlanAdapter extends RecyclerView.Adapter<CompanyPlanAdapter.MyViewHolder> {

    CompanyPlansFragments mContext;
    JsonArray data;
    private MyViewHolder oldHolder;


    public CompanyPlanAdapter(CompanyPlansFragments mContext, JsonArray data) {
    ...
    @NonNull
    @Override
    public CompanyPlanAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CompanyPlanAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
