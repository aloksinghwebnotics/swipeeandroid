...
import com.swipee.in.BuildConfig;
...
public class BillingHelper {
	...
	protected static void confirmTransaction(String[] notifyIds) {
		...
		try {
			...
			// The RESPONSE_CODE key provides you with the status of the request BillingHelper not fully instantiated
			Integer responseCodeIndex = (Integer) response.get("RESPONSE_CODE");
			C.ResponseCode responseCode = C.ResponseCode
					.valueOf(responseCodeIndex);
	...
	private static Bundle makeRequestBundle(String method) {
		...
		request.putInt("API_VERSION", BuildConfig.VERSION_CODE);
